                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-group">
										...
										<input type="text" name="namaproduk" class="form-control" style="border: 1px solid #000000;">
                                        <label>Deskripsi</label>
                                        <input type="text" name="namaproduk" class="form-control" style="border: 1px solid #000000;">
                                        <label>Kategori</label>
                                        <input type="text" name="namaproduk" class="form-control" style="border: 1px solid #000000;">
                                        <label>Harga Produk Sebelum Diskon</label>
                                        <input type="number" name="namaproduk" class="form-control" style="border: 1px solid #000000;">
                                        <label>Harga Produk Pasca Diskon</label>
                                        <input type="number" name="namaproduk" class="form-control" style="border: 1px solid #000000;">
                                        <label>Rate</label>
                                        <input type="number" name="rate" class="form-control" style="border: 1px solid #000000;">
									</form>
								 </div>
                            </div>
                        </div>
